...
function draw() {
  ...
  if (mouseIsPressed && mouseY > 40 && mouseY < 500) {
    switch (tool) {
      ...
      case 2:
        //background(255);
        clr = cityu.get(map(mouseX, 0, width, 0, cityu.width), map(mouseY - 40, 0, height-10, 0, cityu.height));
        tint(clr);
        image(cityu, 0, 40, 510, 510);
        break;
      case 3:
        ...
        switch(rand){
          case 1: filter(THRESHOLD); break; 
          case 2: filter(GRAY); break; 
          case 3: filter(OPAQUE); break; 
          case 4: filter(INVERT); break; 
          case 5: filter(POSTERIZE); break; 
          case 6: filter(BLUR); break; 
          case 7: filter(ERODE); break; 
          case 8: filter(DILATE); break; 
        }*/
        break;
      case 4:
        //noTint();
